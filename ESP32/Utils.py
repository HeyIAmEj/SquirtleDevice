        ...
        try:
            ...
            if(config != ""):
                ...
                for k in config:
                    ...
                    value = int(value[3].replace("value:", ""))
                    config[k] = {'mp':mp, 'pp':pp, 'pt': pt, 'value': value}
                return config
            return {'sensor1': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor4': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor2': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor5': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor3': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}}
        except:
            return {'sensor1': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor4': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor2': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor5': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}, 'sensor3': {'mp': 530, 'pp': 30, 'pt': 20, 'value': 0}}
